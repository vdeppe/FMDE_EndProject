...
/*package*/ class Node_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_aofvvp_a();
  }

  private EditorCell createCollection_aofvvp_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_aofvvp_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createProperty_aofvvp_a0());
    return editorCell;
  }
  private EditorCell createProperty_aofvvp_a0() {
